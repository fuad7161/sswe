export const roadmap = [
    {
      id: 's1',
      title: '1 — Go Programming Language',
      topics: [
        ...
        { title: 'Go Project and Tooling', items: ['Go modules','go.mod','go.sum','go work','Dependency management','Semantic versioning','Build tags','Cross compilation','go build','go run','go test','go vet','go fmt','go generate','go install','pprof','Go benchmarks','golangci-lint','staticcheck','Delve debugger'] }
      ]
    },
    {
      id: 's2',
      title: '2 — Go Standard Library',
      topics: [
        { title: 'Standard Library', items: ['fmt','net/http','context','database/sql','encoding/json','encoding/xml','os','io','bufio','bytes','strings','strconv','sort','regexp','time','sync','sync/atomic','errors','log/slog','crypto','crypto/tls','crypto/sha256','crypto/rand','net','os/signal','syscall','reflect','runtime','testing','embed','flag','text/template','path/filepath'] }
      ]
    },
    {
      id: 's3',
